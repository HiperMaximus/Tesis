...
comparación ampliada confirma que las diferencias entre modelos son sutiles en
...
valores descriptivos para el VAE base. En conjunto, la restricción de
equivarianza y la reducción de 70,2\% en parámetros no ocasionaron una
degradación grande de reconstrucción, pero tampoco mejoraron su fidelidad en
esta prueba.
...
hipótesis aún abierta. La acción exacta del decodificador
VAE-\(\mathrm{SO}(2)\) en cuartos de vuelta quedó verificada, y a un grado se
